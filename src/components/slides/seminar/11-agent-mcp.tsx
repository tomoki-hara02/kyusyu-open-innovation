...
export default function Slide11AgentMcp() {
  const byId = useMemo(
      ...
      >
        ...
        <div className="flex flex-row flex-1 min-h-0 gap-6 items-stretch">
          ...
          <div className="flex-1 min-w-0 flex flex-col">
            ...
            >
              <defs>
                <filter id="p12-glow" x="-100%" y="-100%" width="300%" height="300%">
                ...
                <filter id="p12-soft" x="-100%" y="-100%" width="300%" height="300%">
                ...
                <radialGradient id="p12-core-grad" cx="50%" cy="50%" r="50%">
              ...
              {NODES.map((n, i) => (
                ...
                >
                  {n.hub && (
                    <circle cx={n.x} cy={n.y} r={n.r + 26} fill="url(#p12-core-grad)" opacity={0.5} />
                  )}
                  <motion.circle
                    cx={n.x} cy={n.y} r={n.r}
                    fill="none"
                  ...
                  <circle
                    ...
                    filter={n.hub ? 'url(#p12-soft)' : undefined}
                  />
