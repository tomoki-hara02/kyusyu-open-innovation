...
const APPROACHES = [
  ...
  {
    tag: '技術的',
    message: '社内端末でないとログインできない\n— ログインサービス × SSO連携やIAM設定',
    accent: '#88bbff',
  },
];
...
export default function Slide41AccessibleDevices() {
  return (
    <SlideWrapper>
      <motion.div
          ...
          {APPROACHES.map((item, i) => (
            ...
            >
              ...
              <div className="flex items-start gap-3 pl-2">
                ...
                <p
                  className="font-semibold text-white leading-snug whitespace-pre-line"
              ...
              {i === 1 && (
                <div className="pl-2">
                  <RelatedRuleLink
                    targetId="37-account-management"
